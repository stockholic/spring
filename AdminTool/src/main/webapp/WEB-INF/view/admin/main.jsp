...
<div class="row">
	...
	<div class="col-md-4">
		<div class="info-box bg-aqua">
            <span class="info-box-icon"><i class="fa fa-fw fa-download"></i></span>

            <div class="info-box-content">
              <span class="info-box-text">디스크사용랑 C:/</span>
          ...
          <div class="info-box bg-aqua">
            ...
            <div class="info-box-content">
              <span class="info-box-text">디스크사용랑 D:/</span>
              <span class="info-box-number">163,921 / 10,000,000</span>
