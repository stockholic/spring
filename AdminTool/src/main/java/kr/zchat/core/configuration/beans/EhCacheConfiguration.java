...
@Configuration
@EnableCaching
//@ComponentScan(basePackages = "kr.zchat.webapp")
@ComponentScan( basePackages = "kr.zchat.webapp", includeFilters = { @ComponentScan.Filter(type = FilterType.ANNOTATION, classes = Service.class) } )
