...
import kr.zchat.core.configuration.filter.AjaxSessionTimeoutFilter;
import kr.zchat.core.configuration.filter.SSOAuthenticationFilter;
import kr.zchat.core.configuration.handler.LoginFailureHandler;
import kr.zchat.core.configuration.handler.LoginSuccessHandler;
import kr.zchat.core.configuration.handler.SSOLoginHandler;
...
//			.antMatchers("/adm/**").access("hasRole('ROLE_ADM')")
