  ...
  <div class="login-box-body">
    ...
    <c:if test="${!empty param.err}">
      ...
      <div class="form-group has-feedback">
        <input type="text" name="userNm" id="userNm" value="admin" class="form-control" placeholder="아이디" autofocus autocomplete="off">
        
        
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control" name="password" id="password" value="1234" placeholder="Password"  autocomplete="off">
